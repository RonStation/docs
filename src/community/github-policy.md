...
All PRs, regardless of their priority, are to be validated by someone else than the PR's authors.
In cases where this is not possible, the approver takes responsibility of the merge.
